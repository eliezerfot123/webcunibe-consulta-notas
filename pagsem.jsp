...
<!--Incono del CUNIBE-->
  ...
  <title>Colegio Universitario &quot;Dr. Rafael Belloso Chac&iacute;n&quot; - M&oacute;dulo de Consultas - Pagos de Cuotas</title>
 </head>
 <body background="imagenes/background.gif" bgcolor="#FFFFFF">
    ...
    <!-- Tabla de titulo de CUOTAS DE PAGOS -->
                ...
                <div align="center">
                    <table width="713" border="0" bgcolor="#3184bd" cellpadding="4">
                        <tr>
                            <td bgcolor="white">
                                <div align="center">
                                    <b><font color="#310000" face="tahoma,arial">CUOTAS DE PAGOS</font></b>
                                </div>
                            </td>
                        </tr>
                    </table>
    ...
    <table align="center" width="718" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td>
                ...
                <table align="center" width="663" border="1" cellspacing="0" cellpadding="2">
                ...
                <br>
                <!-- 2 da Consulta de Cuotas de Pagos -->
                <table align="center" width="663" border="1" cellspacing="0" cellpadding="2">
                    <tr bgcolor="#003366">
                        <td bgcolor="#3184bd" align="center" width="20%"><b><font color="#FFFFFF" face="tahoma,arial">N&uacute;mero de Cuota</font></b></td>
                        <td bgcolor="#3184bd" align="center" width="21%"><b><font color="#FFFFFF" face="tahoma,arial">Concepto de Pago</font></b></td>
                        <td bgcolor="#3184bd" align="center" width="21%"><b><font color="#FFFFFF" face="tahoma,arial">Monto a Cancelar</font></b></td>
                        <td bgcolor="#3184bd" align="center" width="21%"><b><font color="#FFFFFF" face="tahoma,arial">Saldo Pendiente</font></b></td>
                        <td bgcolor="#3184bd" align="center" width="20%"><b><font color="#FFFFFF" face="tahoma,arial">Fecha de Pago</font></b></td>
                    </tr>
                        <sql:query>SELECT orden_pago,concepto_pago,monto_pendiente,saldo_pendiente,fecha_pago FROM pagos WHERE cedula = '<sql:escapeSql><%=cedula%></sql:escapeSql>' AND periodo_semestre = '<sql:escapeSql><%=periodo%></sql:escapeSql>' ORDER BY 1</sql:query>
                        <sql:resultSet id="rset2">
                    <tr bgcolor="#FFFFFF">
                        <td align="center" width="20%"><font color="#310000" face="tahoma,arial">&nbsp;<sql:getColumn position="1"/></font></td>
                        <td align="center" width="21%"><font color="#310000" face="tahoma,arial">&nbsp;<sql:getColumn position="2"/></font></td>
                        <td align="center" width="21%"><font color="#310000" face="tahoma,arial">&nbsp;<sql:getNumber position="3" format="CURRENCY" locale="es_VE"/></font></td>
                        <td align="center" width="21%"><font color="#310000" face="tahoma,arial">&nbsp;<sql:getNumber position="4" format="CURRENCY" locale="es_VE"/></font></td>
			<td align="center" width="20%"><font color="#310000" face="tahoma,arial">&nbsp;<sql:getDate position="5" format="SHORT" locale="es_VE"/></font></td>
                    </tr>
                        </sql:resultSet>
                </table>
                <br>
                            ...
                            <table  width="713" border="0" bgcolor="#3184bd" cellpadding="4">
                                <tr>
                                    <td align="right" colspan="2" bgcolor="#ffffff">
                                       ...
                                       <b><font color="#000000" face="tahoma,arial">&nbsp;&nbsp;&nbsp;&nbsp;<IMG SRC="imagenes/vineta.gif" alt="" WIDTH=15 HEIGHT=12>&nbsp;&nbsp;Alumno no concluyo proceso de inscripci&oacute;n.</font></b><br><br>
                                       <b><font color="#000000" face="tahoma,arial">&nbsp;&nbsp;&nbsp;&nbsp;<IMG SRC="imagenes/vineta.gif" alt="" WIDTH=15 HEIGHT=12>&nbsp;&nbsp;Alumno no est&aacute; inscrito para este per&iacute;odo acad&eacute;mico.&nbsp;</font></b></div><br>
                                        </sql:wasEmpty>
                                        <sql:wasNotEmpty>
                                       <b><font color="#000000" face="tahoma,arial">&nbsp;<sql:rowCount/>&nbsp;Pagos Realizados.&nbsp;</font></b><br>
                                        </sql:wasNotEmpty>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <div align="center">
                            <table border="0" cellpadding="4" bgcolor="#3184bd" width="425">
                                <tr>
                                    <td bgcolor="#FFFFFF">
                                        <div align="center">
                                            <b><font color="#310000" face="tahoma,arial">&nbsp;PARA INFORMACI&Oacute;N SOLAMENTE. NO ES CONSTANCIA DE PAGOS.</font></b>
                                        </div>
                                    </td>
                                </tr>
                            </table>
