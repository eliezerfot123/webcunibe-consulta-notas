...
<html>
 ...
 <body background="imagenes/background.gif" bgcolor="#FFFFFF">
    ...
    <table align="center" width="718" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td>
                <!-- Tabla de titulo de DATOS PERSONALES DEL ALUMNO -->
                            ...
                            <div align="center">
                                <table  width="713" border="0" bgcolor="#3184bd" cellpadding="4">
                                    <tr>
                                        <td bgcolor="white">
                                            <div align="center">
                                                <b><font color="#310000" face="tahoma,arial">DATOS PERSONALES DEL ALUMNO</font></b>
                                            </div>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <table  width="713" border="0" bgcolor="#3184bd" cellpadding="4">
                                <tr>
                                    <td align="right" colspan="2" bgcolor="#ffffff">
                                       ...
                                       <b><font color="#000000" face="tahoma,arial">&nbsp;&nbsp;&nbsp;&nbsp;<IMG SRC="imagenes/vineta.gif" alt="" WIDTH=15 HEIGHT=12>&nbsp;&nbsp;Alumno no est&aacute; inscrito en el Colegio Universitario &quot;Dr. Rafael Belloso Chac&iacute;n&quot;.</font></b></div><br>
                                        </sql:wasEmpty>
                                        <sql:wasNotEmpty>
                ...
                <table border="0" cellPadding="2" cellSpacing="3" align="center">
                    <tr>
                        <td bgcolor="#3184bd">
                            <div align="center">
                                <table border="0" cellpadding="4" bgcolor="#3184bd" width="250">
                                    <tr>
                                        <td bgcolor="#FFFFFF">
                                            <div align="center">
                                                <b><font color="#310000" face="tahoma,arial">&nbsp;PARA INFORMACI&Oacute;N SOLAMENTE.</font></b>
                                            </div>
                                        </td>
                                    </tr>
                                </table>
